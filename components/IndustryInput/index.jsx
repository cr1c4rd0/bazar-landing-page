...
import styles from '../FormDemo2/formDemo2.module.css'
...
const optionsIndustry = [
  ...
  {value: 'Consumer Manufacturing', label: 'Consumer Manufacturing'},
...
export function IndustryInput() {
  ...
  return (
    // <div className={styles['form__input-industry']}>
      /* <Select
        styles={customStyles}
      ...
      <select 
        ...
        {...register('industry')}
        >
        <option vlaue="hola1">hola1</option>
        <option vlaue="hola2">hola2</option>
        <option vlaue="hola3">hola3</option>
...
export function CountryInput() {
  ...
  return (
    <div className={styles['form__input-country']}>
      <Select
        styles={customStyles}
